                                ...
                                <div class="card shadow mb-3">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <center>
                                        <div class="col-lg-3">
                                        <div class="card-body text-center shadow"><img class="" src="/assets/img/52d4a864-fb0d-438f-abb6-c54d3feaf1ab.jfif" width="160" height="160">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col">
                                                    <div class="form-group"><label for="last_name"><strong>Material</strong></label><input class="form-control" type="text" placeholder="{{$estufa->material}}" name="material" disabled></div>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="col">
